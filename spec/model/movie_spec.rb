...
RSpec.describe Movie, type: :model do
  before :each do
    user = User.create(first_name: 'Jack', surname: 'Smith', username: 'Jackson', email: 'haba@sample.com',
                       password: '123456', password_confirmation: '123456')
    movie = Movie.create(title: 'Movie Test three', description: 'Higly rated movie', movie_length: '3hrs',
